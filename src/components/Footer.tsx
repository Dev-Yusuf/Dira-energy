...
const Footer = () => {
    ...
    <section>
      <div className="flex flex-row justify-between bg-PrefooterBg py-4 px-6 lg:px-16">
        ...
        <div className="flex mt-6 -mx-2">
          <a
            href="https://www.linkedin.com/help/linkedin/answer/104319/invite-connections-to-follow-your-linkedin-page"
  ...
  >
    ...
    >
      <path
        d="M1.25447 1.25447H18.7455V18.7455H1.25447V1.25447ZM10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0ZM10 18.1818C5.6166 18.1818 2.18182 14.747 2.18182 10.3636C2.18182 5.98023 5.6166 2.54545 10 2.54545C14.3834 2.54545 17.8182 5.98023 17.8182 10.3636C17.8182 14.747 14.3834 18.1818 10 18.1818Z"
        fill="white"
      />
      <path
        d="M15.3836 13.4715C15.0751 13.8054 13.923 14.8893 13.473 15.113C13.023 15.3367 12.509 15.2635 12.1005 15.0748C11.692 14.886 10.6454 14.1075 9.68909 13.2576C8.73277 12.4077 7.87045 11.5216 7.63636 11.0909C7.40227 10.6603 7.33586 10.1466 7.45455 9.65818C7.57324 9.1698 8.11364 8.47902 8.29545 8.20455C8.47727 7.93007 8.56818 7.89773 8.81818 8.13636C9.06818 8.375 9.73295 8.97102 9.89091 9.06818C10.0489 9.16534 10.1928 9.25262 10.2909 9.40455C10.3891 9.55648 10.3966 9.7723 10.25 9.90909C10.1034 10.0459 9.71364 10.3273 9.60909 10.4455C9.50455 10.5636 9.49909 10.6503 9.5 10.7545C9.50091 10.8587 9.73113 11.1542 10.0909 11.5455C10.4507 11.9367 11.1073 12.6784 11.6818 13.0909C12.2562 13.5034 12.5273 13.6909 12.7591 13.65C12.9909 13.6091 13.7723 13.1614 14.0364 12.9773C14.3005 12.7932 14.5091 12.7381 14.7364 12.8136C14.9636 12.8891 15.692 13.1377 15.8182 13.1818C15.9443 13.2259 15.692 13.1377 15.3836 13.4715Z"
        fill="white"
      />
    </svg>
  </a>
